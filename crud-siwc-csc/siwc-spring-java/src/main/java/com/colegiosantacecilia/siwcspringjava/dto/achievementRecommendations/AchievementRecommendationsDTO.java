package com.colegiosantacecilia.siwcspringjava.dto.achievementRecommendations;
 ...
 */
@Validated
public class AchievementRecommendationsDTO {
    ...
    public AchievementRecommendationsDTO() {
    }
    ...
    public String toString() {
        return "AchievementRecommendationsDTO{"
                + "\ncode=" + code
